...
document.writeln("<a href=\"javascript:void(0)\" onclick='openZoosUrl()' target=\"_blank\"><img src=\"/js/ru-3.jpg\" border=\"0\"></a></div>");
...
document.writeln("<div class=\"chat_title\">SBM jane приглашает Вас на чат.</div>");
...
document.writeln("<div class=\"chat_text\">Здравствуйте, Добро пожаловать на наш веб-сайт. Если у Вас возникли вопросы, пожалуйста, этот запрос диалога, и я помогу вам пройти.</div>");
document.writeln("<div class=\"chat_botton\">");
document.writeln("<div class=\"botton_no\"><a href=\"javascript:void(0)\" onclick=\"closeWindow();\">прямо спустя</a></div>");
document.writeln("<div class=\"botton_yes\"><a href=\"javascript:void(0)\" onclick='openZoosUrl()' target=\"_blank\">прямо сейчас</a></div>");
document.writeln("</div>");
document.writeln("</div>");
document.writeln("</div>");
document.writeln("</div>");
